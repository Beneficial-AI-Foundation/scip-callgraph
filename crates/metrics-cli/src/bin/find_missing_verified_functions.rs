...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("  Built index of {} unique function names", atom_names.len());
    ...
    println!("═══════════════════════════════════════════════════════════════");
    println!();
    println!("Total verified functions with proofs (trivial_proof=no): {}", verified_with_proofs.len());
    println!("Found in atoms JSON: {}", verified_with_proofs.len() - missing.len());
    ...
    if missing.is_empty() {
        ...
        println!("⚠️  The following {} functions need to be regenerated:", missing.len());
        println!();
